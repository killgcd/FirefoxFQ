...
:ip2
start /wait "" "%~dp0trojan-go\ip_Update\ip_2.bat"
goto startfq

:ip1
start /wait "" "%~dp0trojan-go\ip_Update\ip_1.bat"
goto startfq
...
start "" "trojan-go.exe"
cd ..
start "" "%~dp0Firefox/firefox.exe" -no-remote -profile "%~dp0Firefox/Profile" https://www.bannedbook.org/bnews/fq/?utm_source=ff-trojan-go
