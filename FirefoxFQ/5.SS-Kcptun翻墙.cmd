...
:ip2
start /wait "" "%~dp0SS-Kcptun\ip_Update\ip_2.bat"
goto startfq

:ip1
start /wait "" "%~dp0SS-Kcptun\ip_Update\ip_1.bat"
goto startfq

:startfq

start "" "%~dp0SS-Kcptun\Shadowsocks.exe"
start "" "%~dp0Firefox/firefox.exe" -no-remote -profile "%~dp0Firefox/Profile" https://www.bannedbook.org/bnews/fq/?utm_source=ff-SS-Kcptun
